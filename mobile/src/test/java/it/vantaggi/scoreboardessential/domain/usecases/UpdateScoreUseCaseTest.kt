...
@Test
fun `incrementScore for team 1 increases score by 1`() = runTest {
// When
...
@Test
fun `decrementScore does not go below zero`() = runTest {
// When
...
@Test
fun `incrementScore syncs with Wear`() = runTest {
// When
...
@Test
fun `resetScores sets both scores to zero`() = runTest {
// Given
useCase.incrementScore(1)
