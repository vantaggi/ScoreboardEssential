...
package com.example.scoreboardessential.communication
...
class OptimizedWearDataSync(private val context: Context) {
    ...
    private val TAG = "OptimizedWearDataSync"
    ...
    private val BATCH_SIZE_LIMIT = 10
    ...
    fun syncPlayerList(players: List<com.example.scoreboardessential.PlayerData>) {
        val dataMap = DataMap()
    ...
    fun syncTeamPlayers(team1Players: List<com.example.scoreboardessential.PlayerData>, team2Players: List<com.example.scoreboardessential.PlayerData>) {
        val dataMap = DataMap()
     ...
     */
    private fun addToBatch(path: String, dataMap: DataMap, isUrgent: Boolean) {
    ...
    fun sendMessageWithRetry(
        ...
        scope.launch {
            val nodes = if (targetNodeId != null) {
